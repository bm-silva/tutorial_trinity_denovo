...
source("/programs/trinityrnaseq-v2.12.0/Analysis/DifferentialExpression/R/misc_rnaseq_funcs.R")
source("/programs/trinityrnaseq-v2.12.0/Analysis/DifferentialExpression/R/pairs3.R")
source("/programs/trinityrnaseq-v2.12.0/Analysis/DifferentialExpression/R/vioplot2.R")
data = primary_data
